...
import { handleCategoryChange, handleDescriptionChange, handleImageChange, handleMenuChange, handleNameChange } from "@/utils/handler";
...
export default function FormProdutos({ dataMenus, dataCategory }: Props) {
    ...
    return (
        <form className="m-5" onSubmit={(e: FormEvent<HTMLFormElement>) => {
            handleSubmit(e, router ,{ name, price, image, description, menuId, categoryId },
                setNameError, setPriceError, setImageError, setDescriptionError, setMenuError, setCategoryError, setDisabled)}}>
            <div>
                ...
                <TextField
                    ...
                    variant="outlined"
                    value={name}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => { handleNameChange(e, setName, setNameError) }}
                    error={isNameError}
                ...
                <TextField style={{ width: '100%', marginBottom: '10px' }}
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => { handleImageChange(e, setImage, setImageError) }}
                    error={isImageError}
                ...
                <TextField
                    ...
                    variant="outlined"
                    value={description}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => { handleDescriptionChange(e, setDescription, setDescriptionError) }}
                    multiline
                ...
                <TextField
                    ...
                    style={{ width: '100%', marginBottom: '10px' }}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => { handleMenuChange(e, setMenuId, setMenuError) }}
                    error={isMenuError}
                >
                ...
                <TextField
                    ...
                    style={{ width: '100%', marginBottom: '10px' }}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => { handleCategoryChange(e, setCategoryId, setCategoryError) }}
