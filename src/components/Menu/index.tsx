      ...
      <div className=" flex flex-wrap justify-center m-auto mt-10 w-4/5 ">
        {props.data.map((item: MenuProtocol) => (
          <Link key={item.id} href={`/menu/${item.id}`}>
            <div className="w-44 h-40 m-2 flex justify-center items-center transition ease-in-out delay-150 border border-zinc-950 shadow-md rounded-md hover:-translate-y-1 hover:scale-110 hover:shadow-cyan-500/50 duration-300 hover:cursor-pointer">
